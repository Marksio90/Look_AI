...
| RAM (system) | 32 GB | Mózg 35B-A3B + Docker + Node + przeglądarka |
...
| Qwen3.6-35B-A3B (Mózg) | Q4_K_M | ~20 GB | nie mieści się | ~24–28 GB RAM |
...
Mózg 35B-A3B w Q4_K_M to ~20 GB — **ciasno**. Rozwiązania:
...
| Mózg 35B | 32K | **2K** | CPU offload = wolniejszy; małe kroki = mniej tokenów |
...
| Mózg 35B, 2K ctx, CPU | ~5–15 | CPU offload, wolniejszy |
| Mózg 35B, 2K ctx, GPU (jeśli się zmieści) | ~15–25 | Niestety nie zmieści się w 8 GB |
